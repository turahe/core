...
class Client
{
     ...
     */
    public function createRequest(string $requestType, string $endpoint)
    {
     ...
     * @throws GraphException
     */
    public function createPostRequest(string $endpoint, $body = null)
    {
     ...
     * @throws GraphException
     */
    public function createPatchRequest(string $endpoint, $body = null): \Microsoft\Graph\Http\GraphRequest
    {
     ...
     * @throws GraphException
     */
    public function createPutRequest(string $endpoint, $body = null)
    {
     ...
     * @throws GraphException
     */
    public function createGetRequest(string $endpoint): \Microsoft\Graph\Http\GraphRequest
    {
     ...
     * @throws GraphException
     */
    public function createDeleteRequest(string $endpoint)
    {
     ...
     * @throws GraphException
     */
    public function createCollectionRequest(string $requestType, string $endpoint)
    {
        return $this->addHeaders(
     ...
     * @throws GraphException
     */
    public function createCollectionGetRequest(string $endpoint)
    {
     ...
     *
     *
     * @return \Turahe\Core\Microsoft\Services\Batch\Request
     *
     * @throws GraphException
     */
