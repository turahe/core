...
class SystemInfo implements Arrayable, FromArray, JsonSerializable
{
    ...
    /**
     * Transform the system info to array.
     *
     * @return array
     *
    ...
    public function toArray()
    {
        ...
        return array_merge([
            ...
            'PHP Executable' => \Turahe\Core\Application::getPhpExecutablePath() ?: 'N/A',
            'Installed Version' => \Turahe\Core\Application::VERSION,
            ...
            'Import Status' => \Turahe\Core\Application::importStatus(),
