...
use Turahe\Core\Database\Factories\DashboardFactory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Wildside\Userstamps\Userstamps;

/**
 * Turahe\Core\Models\Dashboard
 *
 * @property-read \Turahe\Users\Models\User $user
 *
 * @method static Builder|Dashboard byUser(int $userId)
 * @method static \Turahe\Core\Database\Factories\DashboardFactory factory($count = null, $state = [])
...
class Dashboard extends Model
{
     ...
     *
     * @param  \Turahe\Users\Models\User|null  $user
