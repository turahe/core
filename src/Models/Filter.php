 ...
 *
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Turahe\Core\Models\FilterDefaultView> $defaults
 * @property-read int|null $defaults_count
 * @property-read \Turahe\Users\Models\User $user
 *
 * @method static \Turahe\Core\Database\Factories\FilterFactory factory($count = null, $state = [])
