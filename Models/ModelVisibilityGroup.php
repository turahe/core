...
/**
 * Modules\Core\Models\ModelVisibilityGroup
 *
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\Users\Models\Organization> $organizations
 * @property-read int|null $organizations_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\Users\Models\User> $users
 * @property-read int|null $users_count
 * @property-read \Illuminate\Database\Eloquent\Model|\Eloquent $visibilityable
 *
 * @method static \Modules\Core\Database\Factories\ModelVisibilityGroupFactory factory($count = null, $state = [])
...
class ModelVisibilityGroup extends Model
{
    ...
    {
        return $this->morphedByMany(\Modules\Users\Models\Organization::class, 'dependable', $this->dependsTable);
    }
